...
if [[ "${TRAVIS_PULL_REQUEST}" != "false" || "${TRAVIS_REPO_SLUG}" != "phantomas1234/e-coli-core" ]]; then
...
echo "Your new report will be visible at https://phantomas1234.github.io/e-coli-core in a moment."
